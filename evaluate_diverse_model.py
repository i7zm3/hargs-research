...
Tests the trained model's ability to generate varied responses and meet the 40% diversity target.
"""
...
def evaluate_model_comprehensive(model: HARGSModelWithMaxDiversity) -> Dict:
    ...
    comprehensive_metrics = {
        ...
        'target_diversity_met': overall_diversity >= 0.40,
...
def main():
    ...
    logger.info(f"Target (40%) Met: {'YES' if results['target_diversity_met'] else 'NO'}")
    ...
    # Success criteria
    if results['diversity_percentage'] >= 40:
        logger.info("\n🎉 SUCCESS: Model achieved 40%+ diversity target!")
    elif results['diversity_percentage'] >= 35:
        logger.info("\n👍 GOOD: Model achieved 35-39% diversity - close to target!")
    elif results['diversity_percentage'] >= 30:
        logger.info("\n✅ OK: Model achieved 30-34% diversity - moderate improvement!")
    else:
        logger.info("\n⚠️ NEEDS IMPROVEMENT: Model achieved <30% diversity - further tuning required!")
